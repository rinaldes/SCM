...
$("#request tbody").append("<tr><td><span class='hidden'>" + $('#product_id').val() + "<span class='product_barcode'>" + $('#number').val() + "</span></td><td>" + $('#merk').val() + "</td><td>" 
  + $('#m_class').val() + "</td><td>" + $('#article').val() + "</td><td>" + $('#quantity').val() + "</td><td>" + $('#harga_pokok').val() + "</td><td>"
